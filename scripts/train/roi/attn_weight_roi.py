...
from hpa.model.localizers import AttnWeightRoILocalizer
...
if __name__ == '__main__':
    ...
    # Read in the config
    # -------------------------------------------------------------------------------------------
    CONFIG_PATH = '/home/mchobanyan/data/kaggle/hpa-single-cell/configs/roi/roi1.yaml'
    ...
    model = AttnWeightRoILocalizer(backbone=backbone_cnn,
                                   final_conv=final_conv,
                                   feature_roi=feature_roi_pool,
                                   class_roi=class_roi_pool)
    ...
    optimizer = AdamW([
        ...
        {'params': model.fc_cell_weights.parameters(), 'lr': LR}
    ])
