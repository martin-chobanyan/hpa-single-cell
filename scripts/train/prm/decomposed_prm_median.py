...
from hpa.model.loss import BackgroundLoss, ClassHeatmapLoss, FocalSymmetricLovaszHardLogLoss
from hpa.utils import create_folder
from hpa.utils.train import checkpoint, Logger, train_epoch3, test_epoch3
...
if __name__ == '__main__':
    ...
    # Read in the config
    # -------------------------------------------------------------------------------------------
    CONFIG_PATH = '/home/mchobanyan/data/kaggle/hpa-single-cell/configs/decomposed/prm/prm5.yaml'
    ...
    for epoch in range(N_EPOCHS):
        train_results = train_epoch3(model=model,
        ...
        val_results = test_epoch3(model=model,
